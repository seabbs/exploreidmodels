...
2. Select a model of interest, demographic processes can be toggled on or off. 

![Selecting a Susceptible, High risk latent, Low risk latent, Infected, Recovered model.](./img/how_to_choose_model.png)

3. Explore the parameter space of the model using the provided sliders. A summary table of the model simulation is provided as are the raw simulation results.
