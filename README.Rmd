...
```{r out.width = "70%", fig.cap = "A susceptible, exposed, infected, recovered model."}
...
```{r out.width = "70%", fig.cap = "A complex model of Tuberculosis, including reinfection, multiple latent compartments, risk groups and treatment."}
...
```{r out.width = "70%", fig.cap = "Explore Model Dynamics tab for the Explore Infectious Disease web app."}
...
```{r out.width = "70%", fig.cap = "Selecting a Susceptible, High risk latent, Low risk latent, Infected, Recovered model."}
...
```{r out.width = "70%", fig.cap = "Varing the high risk latent period."}
