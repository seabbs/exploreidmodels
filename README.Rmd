...
```{r out.width = "50%", fig.cap = "Explore Model Dynamics tab for the Explore Infectious Disease web app."}
...
```{r out.width = "50%", fig.cap = "Selecting a Susceptible, High risk latent, Low risk latent, Infected, Recovered model."}
...
```{r out.width = "50%", fig.cap = "Varing the high risk latent period."}
